            ...
            <section class="template-gallery-section">
              <div class="template-gallery-heading">
                ...
                <div class="template-actions">
                  <button class="app-new-template" id="app-new-template" type="button">
                    ${window.lang == 'ru' ? 'Сохранить текущий' : 'Save current'}
                  </button>
                  <button class="app-delete-template" id="app-delete-template" type="button">
