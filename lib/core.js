      ...
      $(`${containerSelector} .main-panel`).append(`
        <div class="toolpanel" id="export-template-panel">
          <div class="content template-export-content">
            <p class="title">
              ${window.lang == 'ru' ? 'Экспорт шаблона' : 'Export template'}
            </p>
            <p class="section-hint">
              ${window.lang == 'ru'
                ? 'Пока экспортируется grid: конфиг, готовый фон и используемые шрифты.'
                : 'Grid export currently includes the config, rendered background and used fonts.'}
            </p>
