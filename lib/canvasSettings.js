          ...
          <div class="content">
            ...
            <section class="trim-settings-section">
              ...
              <div class="trim-values-grid">
                <label><span>${isRussian ? 'Слева' : 'Left'}</span><input type="number" value="${trim.left}" readonly></label>
                <label><span>${isRussian ? 'Сверху' : 'Top'}</span><input type="number" value="${trim.top}" readonly></label>
                <label><span>${isRussian ? 'Справа' : 'Right'}</span><input type="number" value="${trim.right}" readonly></label>
                <label><span>${isRussian ? 'Снизу' : 'Bottom'}</span><input type="number" value="${trim.bottom}" readonly></label>
              </div>
              <p class="trim-unit-note">px</p>
              ...
              <div class="trim-values-grid trim-visible-values">
                <label><span>${isRussian ? 'Ширина' : 'Width'}</span><input type="number" value="${visibleWidth}" readonly></label>
                <label><span>${isRussian ? 'Высота' : 'Height'}</span><input type="number" value="${visibleHeight}" readonly></label>
              </div>
