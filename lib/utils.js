...
(function () {
   ...
   */
    ...
    this.addImageFromUrl = (imgUrl, asset = {}) => {
      const _self = this;
      const revision = _self.canvas.projectRevision || 0;
      ...
      imgElement.onload = function () {
        if ((_self.canvas.projectRevision || 0) !== revision) return;
        fabric.Image.fromURL(imgUrl, (img) => {
          ...
          img.set({
            ...
            assetFileName: asset.name || null,
            assetFileSize: asset.size || null,
          });
          ...
          $(
            `${_self.containerSelector} #toolbar .main-buttons > button, `
            + `${_self.containerSelector} #toolbar .toolbar-tool-popover button`,
          ).removeClass('active');
        }, {
