...
(function () {
  ...
  var freeDrawSettings = function () {
    ...
    $(`${this.containerSelector} .toolpanel#draw-panel .content #color-picker`).change(function (_event, selectedColor) {
      try {
        color = window.colorToHex(selectedColor || $(this).spectrum('get'));
        if (!color) return;
        this.value = color;
        updateBrush();
      } catch (_) {}
