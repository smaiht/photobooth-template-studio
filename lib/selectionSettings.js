...
(function () {
  ...
  var selectionSettings = function () {
    ...
    (() => {
        ...
        <div class="text-section">
          ...
          <div class="sizes">
            ...
            <div class="input-container">
              ...
              <input type="range" min="1" max="200" value="20" id="fontSize">
            </div>
            ...
            //   <input type="number" min="1" value="20" id="fontSize2">
      ...
      $(`${this.containerSelector} .toolpanel#select-panel .sizes #fontSize`)
        .on('input', function() { // Обновление в реальном времени
          let value = parseFloat($(this).val());
          _self.setActiveFontStyle(_self.activeSelection, 'fontSize', value);
          _self.canvas.renderAll();
        })
      ...
      $(`${this.containerSelector} .toolpanel#select-panel .family #font-family`).change(function() {
        ...
        WebFont.load({
          google: {
            families: [`${fontFamily}:400,700:cyrillic,latin`],
            text: _self.activeSelection.text,
            subset: ['cyrillic', 'latin'] 
          },
          active: function() {
            // Apply font after it's loaded
            _self.setActiveFontStyle(_self.activeSelection, 'fontFamily', fontFamily);
            _self.canvas.renderAll();
            _self.canvas.fire('object:property-realy-changed');
            ...
            WebFont.load({
              ...
              // active: function() {
              //   console.log('Полная загрузка шрифта завершена');
              // }
            });
        ...
        if (activeObject) {
          ...
          const setValue = (selector, value, silent = true) => {
            if (value !== undefined && value !== null) {
              ...
              _self.canvas.renderAll()
              // const $element = $(`${_self.containerSelector} .toolpanel#select-panel ${selector}`);
